...
- If the user says "show me listing details of CometChat" (or similar phrasing requesting the listing), immediately call listing-tool to open the Product Hunt page.
